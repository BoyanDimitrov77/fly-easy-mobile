...
public class MyHotelsActivity extends AppCompatActivity implements HasSupportFragmentInjector {
    ...
    private void processResponse(Response response) {
        ...
        switch (response.status) {
            ...
            case SUCCESS:
                ...
                MyHotelsFragment myHotelsFragment = new MyHotelsFragment();
                myHotelsFragment.setArguments(bundle);
                //start fragment
                android.support.v4.app.FragmentManager fragmentManager = this.getSupportFragmentManager();
                int containerId = R.id.container;
                fragmentManager.beginTransaction()
                        .replace(containerId, myHotelsFragment)
